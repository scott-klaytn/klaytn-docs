...
예. Klaytn은 스마트 컨트랙트 언어로서 Solidity를 지원합니다. 이더리움 스마트 컨트랙트 언어 Solidity로 작성된 [ERC-20](../nodes/downloads/downloads.md) 및 [ERC-721](../nodes/downloads/downloads.md)은 Klaytn에서 배포 및 실행될 수 있습니다.
